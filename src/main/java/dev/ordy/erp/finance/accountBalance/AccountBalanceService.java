...
public class AccountBalanceService {
    ...
    public AccountBalance createAccountBalance(Account account, Double balance, FinancialStatus balanceStatus, Currency currency) {
    ...
    public AccountBalance getAccountBalanceByAccount(Account account) {
        return accountBalanceRepository.findByAccount(account); //ToDo error handling
